    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col ">
                    <div class="jumbotron ">
                        <h1 class="display-4">Consultaion</h1>
                        <hr class="my-4">

                        <form action="{{ route('visiteur.consultation') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row align-items-center">
                                ...
                                <div class="col-auto my-1">
                                    <label for="exampleFormControlInput1">Recherecher un enseignant</label>
