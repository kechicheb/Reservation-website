            ...
            <div class="perant-table">
                <div class="row">
                    <div class="col">
                        ...
                        <form id="all-reservation" action="{{ route('admin.consultationReservation') }}" method="POST">
                            @csrf
                            <input hidden name="all_reservation" type="text">
                        </form>
                    </div>
                    <div class="col-12">
                        <form action="{{ route('admin.consultationReservation') }}" method="POST"
                            ...
                            <div class="form-row align-items-center" style="margin-bottom: 5px">
                                ...
                                <div class="col-auto my-1">
                                    ...
                                    <input type="search" name="code_salle" class="form-control" placeholder="Salle">
                                    <span class="text-danger">
                                        @error('code_salle')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="col-auto my-1">
                                    ...
                                    <input type="search" name="name" class="form-control" placeholder="Enseignant">
                                    <span class="text-danger">
                                        @error('name')
                                            {{ $message }}
                                        @enderror
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($reservations as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <span style="margin-top: 2px;" style="cursor: pointer; "
                                                        class="btn btn-primary btn-sm" data-toggle="modal"
                                                        data-target="#contact{{ $item->id }}">Contacter
                                                                    ...
                                                                    <table style="width:100%">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="button-contacter">
                                                                                <span>{!! $item->enseignant->email !!}</span><button
                                                                                    class="btn btn-outline-success btn-sm"
                                                                                    type="button" title="Copié"
                                                                                    onclick="copyToClipboard({{ $item->id }})">Copie</button>
