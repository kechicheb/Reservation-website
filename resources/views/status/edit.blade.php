...
@section('content')
    ...
    <div class="row " style="background-color: #fff;">
        {{-- <div class="col-12 mt-3 mb-2">
            ...
            <h4> Modifier status</h4>
            <hr>
        </div> --}}
            <div class="col  mt-3 mb-2">
                <form action="{{ route('admin.status.update',$statu->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="type_status" class="form-control" value="{{$statu->type_status}}">
